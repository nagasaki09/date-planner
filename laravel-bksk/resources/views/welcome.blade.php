...
<body class="text-center">
  ...
  <!-- Cover -->
  <div class="d-flex align-items-center section-aquamarine py-5 cover" style="background-image: url('/jpg/cover_3.jpg');" >
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-white mt-5">
          <h1 class="display-2 d-none d-md-block">Date Planner</h1>
          <h1 class="display-4 d-block d-md-none">Conference Pingendo</h1>
          <p class="" contenteditable="true">質の高いデートを提案</p>
          <a href="#restaurant" class="btn btn-lg mt-4 btn-outline-light">検索する</a><i class="d-block fa fa-angle-down pt-5 fa-3x"></i>
        </div>
      </div>
    </div>
  </div>
...
<a>分</a></div>
  ...
  <input type="checkbox" id="b_ch６" />
	<label for="b_ch６">雰囲気</label>
      ...
      <div class="row">
        <div class="col-md-4"></div>
        <div class="col-md-4"></div>
        <div class="col-md-4"><button class=" btn btn-primary" type="submit">この条件で検索</button></div>
      </div>
    </div>
  </div>
  ...
  <div class="py-5 section-parallax d-flex "  style="" id="kankou" style="background-image: url(&quot;assets/conference/venue.jpg&quot;);">
    <div class="container">
      <div class="row">
        <div class="col-md-12" style="">
          <h2 class="" contenteditable="true">観光地を検索</h2>
        </div>
      </div>
    </div>
  </div>
...
<option value="沖縄県">沖縄県</option>
      ...
      <div class="row">
        <div class="col-md-12"><div class="cp_ipcheck">
	<input type="checkbox" id="c_ch1" />
	<label for="c_ch1">動物</label>
	<input type="checkbox" id="c_ch2" />
	<label for="c_ch2">景色</label>
	<input type="checkbox" id="c_ch3" />
	<label for="c_ch3">アクティビティ</label>
  <input type="checkbox" id="c_ch４" />
	<label for="c_ch４">のんびり</label>
  <input type="checkbox" id="c_ch５" />
	<label for="c_ch５">アクティブ</label>
  <input type="checkbox" id="c_ch６" />
	<label for="c_ch６">趣のある</label>
</div></div>
      </div>
  ...
  <div class="py-5 section-parallax" id="plan"　style="background-image: url(&quot;assets/conference/schedule.jpg&quot;);" id="schedule" >
    ...
    <div class="container section-aquamarine">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-white mt-4">おすすめプラン</h1>
        </div>
      </div>
        ...
        <div class="p-4 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-block text-center card-primary p-2">
              <h2>Plan1</h2>
              <p class="lead">carefree</p>
            </div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;09:30-10:00 –&nbsp;<b>修善寺温泉</b></li>
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;10:00-12:00 –&nbsp;<b>イタリアン</b></li>
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;12:00-13:00 –&nbsp;<b>海を散歩</b></li>
              <li class="list-group-item bg-info"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;13:00-14:30 –&nbsp;<b>00カフェ</b></li>
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;14:30-16:00 –&nbsp;<b>陶芸</b></li>
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;16:00-18:00 –&nbsp;<b>ドライブ</b></li>
            </ul>
          </div>
        </div>
        <div class="p-4 col-lg-4 col-md-6">
          <div class="card">
            <div class="card-block text-center card-primary p-2">
              <h2 contenteditable="true">Plan2</h2>
              <p class="lead">active</p>
            </div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;09:30-10:00 –&nbsp;<b>瀬戸内海</b></li>
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;10:00-12:00 –&nbsp;<b>気球体験</b></li>
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;12:00-13:00 –&nbsp;<b>和食</b></li>
              <li class="list-group-item bg-info"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;13:00-14:30 –&nbsp;<b>移動</b></li>
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;14:30-16:00 –&nbsp;<b>ダイビング</b></li>
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;16:00-18:00 –&nbsp;<b>２２ホテル</b></li>
            </ul>
          </div>
        </div>
        <div class="p-4 col-lg-4">
          <div class="card text-dark">
            <div class="card-block text-center p-2">
              <h2>Plan3</h2>
              <p class="lead">romantic</p>
            </div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;09:30-10:00 –&nbsp;<b>大山</b></li>
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;10:00-12:00 –&nbsp;<b>登山</b></li>
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;12:00-13:00 –&nbsp;<b>昼食</b></li>
              <li class="list-group-item bg-info"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;13:00-14:30 –&nbsp;<b>カフェ</b></li>
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;14:30-16:00 –&nbsp;<b>ディナー</b></li>
              <li class="list-group-item"><i class="mx-auto fa d-inline fa-clock-o text-primary"></i>&nbsp;16:00-18:00 –&nbsp;<b>イルミ</b></li>
            </ul>
          </div>
        </div>
      </div>
