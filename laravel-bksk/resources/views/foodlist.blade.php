...
<a>分</a></div>
  ...
  <div class="pt-5 border-bottom border-top border-dark" >
      <div class="container">
        <div class="row">
          <div class="col-md-4 mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="/jpg/kadoya.jpg" style="	transform:  translateX(30px)  translateY(60px) ;"> </div>
          <div class="px-md-5 p-3 d-flex flex-column align-items-start justify-content-center col-md-7 order-1 order-md-2">
            <h1>豊洲 KADOYA</h1>
            <ul class="list-group list-group-flush">
              <li class="list-group-item d-flex"><i class="fa fa-cloud text-primary mr-2"></i>ジャンル：ビストロ、ワインバー</li>
              <li class="list-group-item d-flex"><i class="fa fa-bookmark text-primary mr-2"></i>お問い合わせ：080-9663-2916</li>
              <li class="list-group-item d-flex"><i class="fa fa-bell text-primary mr-2"></i>住所：東京都江東区豊洲4-6-4</li>
              <li class="list-group-item d-flex"><i class="fa fa-life-ring text-primary mr-2"></i>価格：¥3000~4000</li>
              <li class="list-group-item d-flex"><i class="fa fa-paper-plane text-primary mr-2"></i>営業時間：18:00~24:00(LO23:30)</li>
            </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="px-md-5 p-3 d-flex flex-column align-items-start justify-content-center col-md-12 order-1 order-md-2">
            <h1>豊洲 KADOYA</h1>
            <ul class="list-group list-group-flush">
              <li class="list-group-item d-flex justify-content-start"><i class="fa fa-cloud text-primary mr-2"></i>ジャンル：ビストロ、ワインバー</li>
              <li class="list-group-item d-flex justify-content-start"><i class="fa fa-bookmark text-primary mr-2"></i>お問い合わせ：080-9663-2916</li>
              <li class="list-group-item d-flex justify-content-start"><i class="fa fa-bell text-primary mr-2"></i>住所：東京都江東区豊洲4-6-4</li>
              <li class="list-group-item d-flex"><i class="fa fa-life-ring text-primary mr-2"></i>価格：¥3000~4000</li>
              <li class="list-group-item"><i class="fa fa-paper-plane text-primary mr-2"></i>営業時間：18:00~24:00(LO23:30)</li>
            </ul>
            <div class="row text-muted">
        ...
        <div class="col-md-6"><img class="img-fluid d-block" src="/jpg/kadoya.jpg" style="	transform:  translateY(70px) ;"></div>
      </div>
    </div>
  </div>

  <div class="pt-5 border-bottom border-dark" >
      <div class="container">
        <div class="row">
          <div class="col-md-4 mr-auto order-2 order-md-1"> <img class="img-fluid d-block" src="/jpg/kadoya.jpg" style="	transform:  translateX(30px)  translateY(60px) ;"> </div>
          <div class="px-md-5 p-3 d-flex flex-column align-items-start justify-content-center col-md-7 order-1 order-md-2">
